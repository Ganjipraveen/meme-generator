...
class MemeGenerator extends Component {
  ...
  imageUrlChange = event => this.setState({imageUrl: event.target.value})

  topTextChange = event => this.setState({topText: event.target.value})

  bottomTextChange = event => this.setState({bottomText: event.target.value})

  fontSizeChange = event => this.setState({fontSize: event.target.value})
